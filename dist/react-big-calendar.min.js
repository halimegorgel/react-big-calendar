!(function(e, t) {
  ...
  function q(e, t, n) {
    return (e = $((e = B((e = X((e = new Date(e)), t, n)), 1, t)), 1, L))
  }
  ...
  function qe(e, t, n) {
    ...
    var r = typeof t
    return (
      !!('number' == r ? Ye(n) && Xe(t, n.length) : 'string' == r && t in n) &&
      Oe(n[t], e)
    )
  }
  function Ge(e) {
  ...
  function xt(e, t) {
    ...
    if ('fixed' === gt(e, 'position')) n = e.getBoundingClientRect()
      ...
      var o =
        ...
        (function(e) {
          for (
            ...
            St(n) && 'HTML' !== n.nodeName && 'static' === gt(n, 'position');
      ...
      var a = String(gt(o, 'borderTopWidth') || 0)
      r.top += parseInt(a, 10) - Ot(o) || 0
      var i = String(gt(o, 'borderLeftWidth') || 0)
      r.left += parseInt(i, 10) - _t(o) || 0
    }
    var s = String(gt(e, 'marginTop') || 0),
      c = String(gt(e, 'marginLeft') || 0)
    return ft({}, n, {
  ...
  var At = function(e) {
      'function' == typeof window[Pt] && window[Pt](e)
    },
    Rt = kt,
    Ct = (function(e) {
      function t() {
      ...
      return (
        ...
        (t.prototype.render = function() {
          ...
          var M = h.title(o),
            ...
            j = h.start(o),
            T = h.allDay(o),
            P = c || T || Ee(j, ye(x, 'day'), 'day') > 1,
            k = m.eventProp(o, j, x, a),
            N = r.createElement(
              'div',
  ...
  function gn(e) {
    return 'html' === vn(e)
      ? e
      : e.assignedSlot || e.parentNode || e.host || yn(e)
  }
  function bn(e) {
  ...
  function Dn(e) {
    ...
    if (c) {
      ...
      b === un(n) && (b = yn(n)),
        o === Bt &&
          ((y = $t), (p -= b.clientHeight - r.height), (p *= s ? 1 : -1)),
        o === qt &&
          ((m = Xt), (f -= b.clientWidth - r.width), (f *= s ? 1 : -1))
    }
    var w,
      E = Object.assign({ position: i }, c && Sn)
    return s
      ? Object.assign(
          Object.assign({}, E),
          {},
  ...
  function Rn(e) {
    return Nn(yn(e)).left + An(e).scrollLeft
  }
  function Cn(e) {
    var t = hn(e),
      n = t.overflow,
  ...
  function Ln(e, t) {
    ...
    var n = (function e(t) {
      ...
      r = 'body' === vn(n),
      o = un(n),
      a = r ? [o].concat(o.visualViewport || [], Cn(n) ? n : []) : n,
      i = t.concat(a)
    return r ? i : i.concat(Ln(gn(a)))
  }
  function Fn(e) {
    return Object.assign(
      Object.assign({}, e),
  ...
  function Vn(e, t) {
    ...
    var n = t,
      ...
      g = e.rects.popper,
      b = e.elements[d ? m : u],
      w = In(fn(b) ? b : b.contextElement || yn(e.elements.popper), i, c),
      E = Nn(y),
      _ = Hn({ reference: E, element: g, strategy: 'absolute', placement: o }),
      O = Fn(Object.assign(Object.assign({}, g), _)),
      M = u === nn ? O : E,
      S = {
  ...
  function Yn(e) {
    return [Bt, Xt, $t, qt].some(function(t) {
      return e[t] >= 0
    })
  }
  function Bn(e, t, n) {
        ...
        (('body' !== vn(t) || Cn(a)) &&
          (c =
            (r = t) !== un(r) && dn(r)
              ...
              : An(r)),
        dn(t)
          ? (((l = Nn(t)).x += t.clientLeft), (l.y += t.clientTop))
          : a && (l.x = Rn(a))),
      {
    ...
    return function(e, t, n) {
      ...
      var o,
        ...
        s = {
          placement: 'bottom',
          orderedModifiers: [],
          options: Object.assign(Object.assign({}, Xn), a),
          modifiersData: {},
        ...
        u = {
          ...
          forceUpdate: function() {
            if (!l) {
              ...
              if (qn(t, n)) {
                ;(s.rects = {
                  reference: Bn(t, wn(n), 'fixed' === s.options.strategy),
                  popper: ln(n),
                }),
                  (s.reset = !1),
          ...
          if (_) {
            if (a) {
              var x = 'y' === w ? Bt : qt,
                ...
                $ = _[w] + V - B - Y,
                X = _[w] + U - B,
                q = _n(p ? Math.min(k, $) : k, P, p ? Math.max(N, X) : N)
              ;(_[w] = q), (D[w] = q - P)
            }
            if (s) {
              var G = 'x' === w ? Bt : qt,
  ...
  try {
    ...
    nr &&
      ...
      window.removeEventListener('test', ar, !0))
  } catch (e) {}
  function ir(e, t, n, r) {
    return (
      (function(e, t, n, r) {
        if (r && 'boolean' != typeof r && !or) {
          var o = r.once,
            a = r.capture,
            i = n
          !or &&
  ...
  var yr = r.forwardRef(function(e, n) {
    ...
    var V = e.children(
      Ht({}, j, {
        ...
        arrowProps: Ht({}, x.arrow, { style: D.arrow, ref: g }),
      })
    )
    if (d) {
      var U = e.onExit,
  ...
  var br,
    wr = Function.prototype.bind.call(Function.prototype.call, [].slice)
  function Er(e, t) {
    if (!br) {
      var n = document.body,
        r =
  ...
  function Dr(e, t, n) {
    return void 0 === n && (n = document), Sr(n, e, t, { passive: !1 })
  }
  function xr(e, t) {
    var n = t.clientX,
      r = t.clientY
  ...
  var Pr = (function() {
    function e(e, t) {
      ...
      ;(this.isDetached = !1),
        ...
        (this._removeTouchMoveWindowListener = Dr(
          'touchmove',
          function() {},
          window
        )),
        (this._removeKeyDownListener = Dr('keydown', this._keyListener)),
        (this._removeKeyUpListener = Dr('keyup', this._keyListener)),
        (this._removeDropFromOutsideListener = Dr(
          'drop',
          this._dropFromOutsideListener
        )),
        (this._onDragOverfromOutisde = Dr(
          'dragover',
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && kr(t, Nr(e))
      }),
      (t.filter = function(e) {
        ...
        var n = this,
          ...
          i = function(t) {
            ;(r = setTimeout(function() {
              ...
              (o = Dr('touchmove', function() {
                return c()
              })),
              (a = Dr('touchend', function() {
                return c()
              }))
          },
          s = Dr('touchstart', i),
      ...
      (t._addInitialEventListener = function() {
        var e = this,
          t = Dr('mousedown', function(t) {
            e._removeInitialEventListener(),
              e._handleInitialEvent(t),
              (e._removeInitialEventListener = Dr(
                'mousedown',
                e._handleInitialEvent
              ))
          }),
          n = Dr('touchstart', function(t) {
            e._removeInitialEventListener(),
        ...
        if (!this.isDetached) {
          ...
          if (
            ...
            if (
              ...
              switch (e.type) {
                case 'mousedown':
                  ;(this._removeEndListener = Dr(
                    'mouseup',
                    this._handleTerminatingEvent
                  )),
                    (this._onEscListener = Dr(
                      'keydown',
                      this._handleTerminatingEvent
                    )),
                    (this._removeMoveListener = Dr(
                      'mousemove',
    ...
    return (
      ...
      (o._selectable = function() {
        var e = this,
          ...
          r = (this._selector = new Pr(this.props.container, {
  ...
  ;(zr.propTypes = {}), (zr.defaultProps = i({}, Cr))
  ...
  var Vr,
    ...
    Kr = (Vr = /[^.]+$/.exec((Ur && Ur.keys && Ur.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + Vr
      : ''
  ...
  function Qr(e) {
    return (
      !(!Fe(e) || ((t = e), Kr && Kr in t)) && (Ve(e) ? Jr : $r).test(Br(e))
    )
    var t
  }
  function eo(e, t) {
  ...
  ;(so.prototype.clear = function() {
    ...
    (so.prototype.has = function(e) {
      var t = this.__data__
      return no ? void 0 !== t[e] : ao.call(t, e)
    }),
    (so.prototype.set = function(e, t) {
      var n = this.__data__
      return (
        (this.size += this.has(e) ? 0 : 1),
        (n[e] = no && void 0 === t ? io : t),
        this
      )
    }),
  ...
  function vo(e) {
    var t = -1,
      n = null == e ? 0 : e.length
    for (this.__data__ = new lo(); ++t < n; ) this.add(e[t])
  }
  function ho(e, t) {
  ...
  function Io(e, t, n) {
    var r = t(e)
    return zo(e) ? r : Fo(r, n(e))
  }
  function Wo() {
    return []
  }
  var Ho = Object.prototype.propertyIsEnumerable,
  ...
  var Bo = Object.prototype,
    ...
    qo = Yo(
      ...
      ? Yo
      : function(e) {
          return Ge(e) && $o.call(e, 'callee') && !Xo.call(e, 'callee')
        }
  var Go = 'object' == typeof e && e && !e.nodeType && e,
    Zo =
      Go && 'object' == typeof module && module && !module.nodeType && module,
    Jo = Zo && Zo.exports === Go ? De.Buffer : void 0,
    Qo =
  ...
  ;(ea['[object Float32Array]'] = ea['[object Float64Array]'] = ea[
    '[object Int8Array]'
  ] = ea['[object Int16Array]'] = ea['[object Int32Array]'] = ea[
    '[object Uint8Array]'
  ] = ea['[object Uint8ClampedArray]'] = ea['[object Uint16Array]'] = ea[
    '[object Uint32Array]'
  ] = !0),
    (ea['[object Arguments]'] = ea['[object Array]'] = ea[
      '[object ArrayBuffer]'
    ] = ea['[object Boolean]'] = ea['[object DataView]'] = ea[
      '[object Date]'
    ] = ea['[object Error]'] = ea['[object Function]'] = ea[
      '[object Map]'
    ] = ea['[object Number]'] = ea['[object Object]'] = ea[
      '[object RegExp]'
    ] = ea['[object Set]'] = ea['[object String]'] = ea[
      '[object WeakMap]'
    ] = !1)
  var na = 'object' == typeof e && e && !e.nodeType && e,
    ra =
      na && 'object' == typeof module && module && !module.nodeType && module,
    oa = ra && ra.exports === na && Me.process,
    aa = (function() {
      try {
    ...
    ia = aa && aa.isTypedArray,
    sa = ia
      ? ta(ia)
      : function(e) {
          return Ge(e) && Ke(e.length) && !!ea[Le(e)]
        },
    ...
    return Ye(e)
      ...
      : (function(e) {
          ...
          for (var n in Object(e))
            va.call(e, n) && 'constructor' != n && t.push(n)
          return t
        })(e)
  }
  function ma(e) {
  ...
  var ba = eo(De, 'DataView'),
    ...
    xa = Br(_a),
    ja = Le
  ;((ba && '[object DataView]' != ja(new ba(new ArrayBuffer(1)))) ||
    (to && '[object Map]' != ja(new to())) ||
    (wa && '[object Promise]' != ja(wa.resolve())) ||
    (Ea && '[object Set]' != ja(new Ea())) ||
    (_a && '[object WeakMap]' != ja(new _a()))) &&
    (ja = function(e) {
      var t = Le(e),
  ...
  function Ca(e, t, n, r, o, a) {
        ...
        i || sa(e)
          ...
          : (function(e, t, n, r, o, a, i) {
              switch (n) {
                ...
                case Po:
                  var c = r & _o
                  if ((s || (s = Eo), e.size != t.size && !c)) return !1
                  var l = i.get(e)
                  if (l) return l == t
                  ;(r |= Oo), i.set(e, t)
                  var u = go(s(e), s(t), r, o, a, i)
                  return i.delete(e), u
                case No:
    ...
    if (!(n & Pa)) {
      var p = u && Ra.call(e, '__wrapped__'),
        v = f && Ra.call(t, '__wrapped__')
      if (p || v) {
        var h = p ? e.value() : e,
          m = v ? t.value() : t
        return a || (a = new fo()), o(h, m, n, r, a)
      }
    }
    return (
      !!d &&
      ...
      (function(e, t, n, r, o, a) {
        ...
        for (var l = c; l--; ) {
          var u = s[l]
          if (!(i ? u in t : ga.call(t, u))) return !1
        }
        var f = a.get(e)
            ...
            (function(e, t, n, r) {
              ...
              for (; ++o < a; ) {
                ...
                if (i && s[2]) {
                  ...
                  if (!(void 0 === d ? La(u, l, Fa | za, r, f) : d)) return !1
                }
              }
              return !0
            })(n, e, t)
  ...
  function Ka(e, t) {
    ...
    return (
      ...
      (Ua.test(e) || !Va.test(e) || (null != t && e in Object(t)))
    )
  }
  ...
  function Ba(e, t) {
    ...
    return (n.cache = new (Ba.Cache || lo)()), n
  }
  Ba.Cache = lo
  var $a = 500
  var Xa,
    ...
    Qa = ((Xa = function(e) {
      ...
      return (
        ...
        e.replace(Za, function(e, n, r, o) {
          t.push(r ? o.replace(Ja, '$1') : n || e)
        }),
        t
      )
    }),
    (qa = Ba(Xa, function(e) {
      return Ga.size === $a && Ga.clear(), e
    })),
    (Ga = qa.cache),
    qa)
  function ei(e, t) {
  ...
  var ti = 1 / 0,
    ni = xe ? xe.prototype : void 0,
    ri = ni ? ni.toString : void 0
  function oi(e) {
    if ('string' == typeof e) return e
    if (zo(e)) return ei(e, oi) + ''
    if (Je(e)) return ri ? ri.call(e) : ''
    var t = e + ''
    return '0' == t && 1 / e == -ti ? '-0' : t
  }
  function ai(e, t) {
    return zo(e)
      ? e
  ...
  function ui(e, t) {
    return (
      null != e &&
      (function(e, t, n) {
        for (var r = -1, o = (t = ai(t, e)).length, a = !1; ++r < o; ) {
          var i = si(t[r])
  ...
  function pi(e, t) {
    return Ka(e) && Ia(t)
      ...
      : function(n) {
          ...
          return void 0 === r && r === t ? ui(n, e) : La(t, r, fi | di)
        }
  }
  function vi(e) {
    return e
  ...
  function wi(e, t) {
    ...
    for (n = 0; n < e.length; n++) {
      for (o = e[n], r = 0; r < a.length && _i(o, a[r]); r++);
  ...
  function Oi(e, t, n) {
    var r = +X(n.start(e), 'day') - +X(n.start(t), 'day'),
      o = Ee(n.start(e), ye(n.end(e), 'day'), 'day'),
      a = Ee(n.start(t), ye(n.end(t), 'day'), 'day')
    return (
      r ||
  ...
  var Di,
    xi = function(e, t, n) {
      return (
        ...
        (function(e, t, n, r) {
          for (
            var o = -1, a = Si(Mi((t - e) / (n || 1)), 0), i = Array(a);
            a--;

          )
            (i[r ? a : ++o] = e), (e += n)
          return i
        })(e, t, (n = void 0 === n ? (e < t ? 1 : -1) : st(n)), Di)
      )
    },
    ji = function(e, t) {
    ...
    Pi = (function(e) {
      ...
      return (
          ...
          for (
            ...
            if (u) {
              ...
              if (this.canRenderSlotEvent(f, p)) {
                var h = Lr(this.props, u)
                v && s.push(Fr(n, v, c + '_gap')),
                  s.push(Fr(n, p, c, h)),
                  (i = a = d + 1)
              } else
                v && s.push(Fr(n, v, c + '_gap')),
                  s.push(Fr(n, 1, c, this.renderShowMore(t, a))),
                  (i = a += 1)
            } else a++
          }
        ...
        (n.canRenderSlotEvent = function(e, t) {
          ...
          return xi(e, e + t).every(function(e) {
            return 1 === Ti(n, e)
          })
        }),
  ...
  ;(Pi.propTypes = {}), (Pi.defaultProps = i({}, Cr))
  var ki = function(e) {
    var t = e.children
    return r.createElement(
      'div',
  ...
  var Li = (function(e) {
    ...
    return (
      (o.getRowLimit = function() {
        var e = gr(this.eventRow),
          t = this.headingRow ? gr(this.headingRow) : 0,
          r = gr(n.findDOMNode(this)) - t
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                i({ isAllDay: M }, A),
                T.map(function(e, t) {
                  return r.createElement(zr, i({ key: t, segments: e }, A))
                }),
                !!P.length &&
                  r.createElement(
                    Pi,
                    i({ segments: P, onShowMore: this.handleShowMore }, A)
                  )
              )
            )
          )
        ...
        return (
          ...
          (t.renderWeek = function(e, n) {
            var o = t.props,
              ...
              g = m.rowLimit
            return (
              (a = Ii(a, e[0], e[e.length - 1], p)).sort(function(e, t) {
                return Oi(e, t, p)
              }),
              r.createElement(Li, {
                key: n,
          ...
          (t.readerDateHeading = function(e) {
            var n = e.date,
              ...
              m = t.props.components.dateHeader || zi
            return r.createElement(
              'div',
              i({}, a, {
      ...
      return (
        ...
        (o.renderHeaders = function(e) {
          var t = this.props,
            ...
            i = e[e.length - 1],
            s = o.header || Fi
          return ge(a, i, 'day').map(function(e, t) {
            return r.createElement(
              'div',
  ...
  ;(Wi.propTypes = {}),
    (Wi.range = function(e, t) {
      var n = t.localizer
      return { start: he(e, n), end: me(e, n) }
    }),
    (Wi.navigate = function(e, t) {
      switch (t) {
        case x.PREVIOUS:
          return B(e, -1, 'month')
        case x.NEXT:
  ...
  var Yi = xe ? xe.isConcatSpreadable : void 0
  function Bi(e) {
    return zo(e) || qo(e) || !!(Yi && e && e[Yi])
  }
  ...
  function es(e, t, n) {
    return (
      (t = Qi(void 0 === t ? e.length - 1 : t, 0)),
      function() {
        for (
          var r = arguments, o = -1, a = Qi(r.length - t, 0), i = Array(a);
          ++o < a;
  ...
  var is = (function(e) {
    ...
    return function() {
      var r = as(),
        o = os - (r - n)
      if (((n = r), o > 0)) {
        if (++t >= rs) return arguments[0]
      } else t = 0
      return e.apply(void 0, arguments)
    }
  })(ns)
  function ss(e, t) {
    return is(es(e, t, vi), e + '')
  }
  var cs = ss(function(e, t) {
      if (null == e) return []
      var n = t.length
      return (
        n > 1 && qe(e, t[0], t[1])
    ...
    var t,
      ...
      P = [
        ...
        r.createElement(
          ...
          g ? r.createElement(g, { event: a, title: w }) : w
        ),
      ]
    return r.createElement(
      b,
      ...
      r.createElement(
        'div',
        {
          ...
          className: D('rbc-event', o, M.className, {
            'rbc-selected': l,
      ...
      return (
        ...
        (t.renderEvents = function() {
          ...
          return (function(e) {
            ...
            var u,
              ...
              b = v.startsBeforeDay(y),
              w = v.startsAfterDay(m)
            b
              ? (g = 'eventTimeRangeEndFormat')
              : w && (g = 'eventTimeRangeStartFormat'),
              (u = b && w ? h.allDay : s.format({ start: y, end: m }, g))
            var E = b || v.startsBefore(y),
              _ = w || v.startsAfter(m)
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(C(t)),
            ...
            a = function(n) {
              var r = t.slotMetrics.closestSlotFromPoint(n, Nr(e))
    ...
    bs = (function(e) {
      function t() {
        ...
        var i = t.props,
          ...
          u = i.step
        return (
          (t.slotMetrics = Ui({ min: s, max: c, timeslots: l, step: u })), t
        )
      }
      c(t, e)
      var n = t.prototype
  ...
  function Es(e) {
    if (((!gs && 0 !== gs) || e) && jt) {
      ...
      ;(t.style.position = 'absolute'),
        ...
        (gs = t.offsetWidth - t.clientWidth),
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          w = t.resizable,
          E = {}
        h && (E[o ? 'marginLeft' : 'marginRight'] = Es() + 'px')
  ...
  var Ss = (function(e) {
    function t(t) {
      ...
      return (
        ...
        (o.memoizedResources = Ai(function(e, t) {
          return (function(e, t) {
            return {
              map: function(n) {
                return e
      ...
      (o.renderEvents = function(e, t, n) {
        ...
        return p.map(function(t, a) {
          ...
          return e.map(function(e, t) {
            var m = (v.get(p) || []).filter(function(t) {
        ...
        return (
          t.forEach(function(e) {
            if (Ei(e, g, b, u)) {
              var t = u.start(e),
                n = u.end(e)
              u.allDay(e) || (we(t) && we(n)) || (!h && !G(t, n, 'day'))
                ? w.push(e)
                : E.push(e)
            }
          }),
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          o = s(e, ['date']),
          a = t.range(n)
        return r.createElement(Ss, i({}, o, { range: a, eventOffset: 10 }))
      }),
      t
    )
  })(r.Component)
  ...
  var xs = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(Ss, i({}, o, { range: a, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  ...
  ;(xs.propTypes = {}),
    (xs.defaultProps = Ss.defaultProps),
    ...
    (xs.range = function(e, t) {
      ...
      return ge(X(e, 'week', n), q(e, 'week', n))
    }),
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            n = s(e, ['date']),
            o = js(t, this.props)
          return r.createElement(Ss, i({}, n, { range: o, eventOffset: 15 }))
        }),
        t
      )
    })(r.Component)
        ...
        if (h.current) {
          ...
          if (t) {
            var n,
              ...
              a = [],
              i = a
            ;(a = [ws(t.children[0]), ws(t.children[1])]),
              (i[0] === a[0] && i[1] === a[1]) ||
  ...
  ;(Ps.propTypes = {}),
    (Ps.defaultProps = Ss.defaultProps),
    (Ps.range = js),
    ...
    (Ns.propTypes = {}),
    (Ns.defaultProps = { length: 30 }),
    (Ns.range = function(e, t) {
      var n = t.length
      return {
        start: e,
        end: B(e, void 0 === n ? Ns.defaultProps.length : n, 'day'),
      }
    }),
    (Ns.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? Ns.defaultProps.length : r
      switch (t) {
        case x.PREVIOUS:
          return B(e, -o, 'day')
        case x.NEXT:
    ...
    (Ns.title = function(e, t) {
      var n = t.length,
        r = void 0 === n ? Ns.defaultProps.length : n,
        o = t.localizer,
        a = B(e, r, 'day')
      return o.format({ start: e, end: a }, 'agendaHeaderFormat')
    })
  var As = (((Ts = {})[j.MONTH] = Wi),
  (Ts[j.WEEK] = xs),
  (Ts[j.WORK_WEEK] = Ps),
  (Ts[j.DAY] = Ds),
  (Ts[j.AGENDA] = Ns),
  ...
  function Is(e, t, n) {
    var r = e[t]
    ;(zs.call(e, t) && Oe(r, n) && (void 0 !== n || t in e)) || Fs(e, t, n)
  }
  function Ws(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var a = -1, i = t.length; ++a < i; ) {
      ...
      void 0 === c && (c = e[s]), o ? Fs(n, s, c) : Is(n, s, c)
    }
    return n
  }
  ...
  function Us(e) {
    return Ye(e) ? la(e, !0) : Vs(e)
  }
  var Ks = 'object' == typeof e && e && !e.nodeType && e,
    Ys =
      Ks && 'object' == typeof module && module && !module.nodeType && module,
    Bs = Ys && Ys.exports === Ks ? De.Buffer : void 0,
    $s = Bs ? Bs.allocUnsafe : void 0
  var Xs = da(Object.getPrototypeOf, Object),
    qs = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) Fo(t, Uo(e)), (e = Xs(e))
          return t
        }
      : Wo
  function Gs(e) {
  ...
  var Qs = /\w*$/
  var ec = xe ? xe.prototype : void 0,
    tc = ec ? ec.valueOf : void 0
  var nc = '[object Boolean]',
    rc = '[object Date]',
    oc = '[object Map]',
    ac = '[object Number]',
    ic = '[object RegExp]',
  ...
  function Ec(e, t, n) {
    ...
    switch (t) {
      ...
      case ic:
        return (
          ((a = new (o = e).constructor(o.source, Qs.exec(o))).lastIndex =
            o.lastIndex),
          a
        )
      case sc:
        return new i()
      case lc:
        return (r = e), tc ? Object(tc.call(r)) : {}
    }
  }
    ...
    if (Dc(e))
      return (
        e.forEach(function(r, o) {
          i.set(o, zc(r, t, n, o, e, a))
        }),
        i
      )
    var v = l ? (c ? Gs : ma) : c ? keysIn : ha,
      h = u ? void 0 : v(e)
    return (
      Ls(h || e, function(r, o) {
        h && (r = e[(o = r)]), Is(i, o, zc(r, t, n, o, e, a))
      }),
      i
    )
  }
  function Ic(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : ci(e, _e(t, 0, -1))
        })(e, (t = ai(t, e)))) ||
      delete e[
        si(((n = t), (r = null == n ? 0 : n.length), r ? n[r - 1] : void 0))
      ]
    )
    var n, r
  }
  ;(Fc[Ac] = Fc['[object Array]'] = Fc['[object ArrayBuffer]'] = Fc[
    '[object DataView]'
  ] = Fc['[object Boolean]'] = Fc['[object Date]'] = Fc[
    '[object Float32Array]'
  ] = Fc['[object Float64Array]'] = Fc['[object Int8Array]'] = Fc[
    '[object Int16Array]'
  ] = Fc['[object Int32Array]'] = Fc['[object Map]'] = Fc[
    '[object Number]'
  ] = Fc[Lc] = Fc['[object RegExp]'] = Fc['[object Set]'] = Fc[
    '[object String]'
  ] = Fc['[object Symbol]'] = Fc['[object Uint8Array]'] = Fc[
    '[object Uint8ClampedArray]'
  ] = Fc['[object Uint16Array]'] = Fc['[object Uint32Array]'] = !0),
    (Fc['[object Error]'] = Fc[Rc] = Fc['[object WeakMap]'] = !1)
  ...
  function Bc(e) {
    return (function(e) {
      if (!Ge(e) || Le(e) != Wc) return !1
      var t = Xs(e)
      if (null === t) return !0
      var n = Kc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Uc.call(n) == Yc
    })(e)
      ? void 0
      : e
  }
  ...
  var Xc = (function(e) {
    ...
    Zc = ss(function(e, t) {
      ...
      for (o && qe(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = Us(a), s = -1, c = i.length; ++s < c; ) {
          var l = i[s],
            u = e[l]
          ;(void 0 === u || (Oe(u, qc[l]) && !Gc.call(e, l))) && (e[l] = a[l])
        }
      return e
    })
  var Jc = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = mi(t)), null == n)) {
                  ...
                  n = o ? (r ? new a() : []) : Fe(e) && Ve(a) ? Oc(Xs(e)) : {}
                }
                return (
                  (o ? Ls : qi)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = c()
          l(
            (a = Rs(f, i({}, u, { action: e, date: n || a || d, today: d }))),
            o,
            e
          ),
    ...
    return (
      ...
      (n.render = function() {
        ...
        var m = this.getView(),
          ...
          _ = y.viewNames,
          O = b.toolbar || Cs,
          M = m.title(u, { localizer: E, length: d })
        return r.createElement(
          'div',
          i({}, l, {
            className: D(c, 'rbc-calendar', h.rtl && 'rbc-rtl'),
            style: a,
          }),
          n &&
            r.createElement(O, {
  ...
  var tl = (function e(t, n, o) {
    ...
    })(el, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    nl = function(e, t, n) {
      var r = e.start,
        o = e.end
  ...
  var ll = function(e, t, n) {
    ...
    fl = { eventWrapper: a, timeSlotWrapper: a, dateCellWrapper: a }
  ;(e.Calendar = tl),
    (e.DateLocalizer = N),
    (e.Navigate = x),
    (e.Views = j),
